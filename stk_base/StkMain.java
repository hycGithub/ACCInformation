 ...
 * 启动器类。 作为应用程序的MAIN活动，向StkAppService发送意图并完成。
 *
 */
 public class StkMain extends Activity {
    ...
    /**
     * @fun ：判断是否插卡，并 初始化simId 的值
     * @return ：true -插卡 ，false - 未插卡
     */
    ...
    /**
     * @function : 根据simId启动 StkAppService
     * @param slotId : sim 卡id号
     *
     */
