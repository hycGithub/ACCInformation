 ...
 * 启动器类。 作为应用程序的MAIN活动，向StkAppService发送意图并完成。进入SIM 应用 ，显示SIM卡列表供用户选择
 *
 */

/**
 * ListActivity可以理解为是ListView和Activity的结合,ListActivity的默认布局由一个位于屏幕中心的全屏列表构成
 */
public class StkLauncherActivity extends ListActivity {
    ...
    // 是否接收用户点击 false 不响应，true 响应
    private boolean mAcceptUsersInput = true;

    @Override
    public void onCreate(Bundle icicle) {
        super.onCreate(icicle);
        // 创建初始化 ，ActionBar，加载布局，设置 标题栏，
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        // mAcceptUsersInput 为false 不响应点击
